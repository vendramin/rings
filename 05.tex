...
December 25, Fermat presented several improvements and claimed to have proved
...
\begin{quote}
\index{Zorn's lemma}
\textcolor{blue!50!black}{\textit{Let $R$ be a poset such that 
...
lemma?}}, but it is logically equivalent to a more intuitive statement in set
theory: the \emph{Axiom of Choice}, which states that the Cartesian product of
a collection of non-empty sets is non-empty. Calling it a lemma rather than an
axiom is purely historical.
