...
a collection of non-empty sets is non-empty.  Zorn's lemma is equivalent to the
Axiom of Choice, so it may be adopted as an equivalent form of that axiom.  The
name is historical.
