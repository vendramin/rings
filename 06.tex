...
\begin{exercise}
 ...
 \]
	is a linear isomorphism of $\C$-algebras. 
\end{exercise}
...
%	\end{pmatrix},
%    \]
    is a linear isomorphism of $K$-algebras. 
\end{exercise}
...
then there exists a unique $K$-algebra homomorphism $\varphi\colon K[G]\to A$ such that
$\varphi|_G=f$. 
...
\begin{proof}
  ...
  Therefore $\rho_g$ is diagonalizable. 
\end{proof}
